...
App.VideoComponent = React.createClass({displayName: "VideoComponent",
  ...
  render: function () {
    return (
      React.createElement("video", {id: "video", width: "640", height: "640"}, 
        React.createElement("source", {type: "video/mp4", src: this.state.movies[0]}), 
        React.createElement("source", {type: "video/mp4", src: this.state.movies[1]})
      )
    );
  }
});
