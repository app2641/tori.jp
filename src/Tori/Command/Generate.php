...
class Generate extends Command
{
    ...
    protected function execute (InputInterface $input, OutputInterface $output)
    {
        try {
            ...
            $this->c_path = sprintf(SRC.'/Tori/Command/%s.php', $this->c_name);
    ...
    private function _generateCommandTestFile ()
    {
        try {
            ...
            file_put_contents(ROOT.'/tests/Tori/Command/'.$this->c_name.'Test.php', $skeleton);
    ...
    private function _rollBackFiles ()
    {
        ...
        if ($this->test_file_flag) {
            $path = sprintf(ROOT.'/tests/Tori/Command/%sTest.php', $this->c_name);
